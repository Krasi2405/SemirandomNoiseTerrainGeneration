...
public static class Noise
{
	...
	private const int hashMask = 254;
	private static float GetValue1D(Vector3 point, float frequency)
	{
		point *= frequency;
	...
	private static float GetValue2D(Vector3 point, float frequency)
	{
		point *= frequency;
